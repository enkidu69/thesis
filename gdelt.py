    ...
    while current_date <= end_date and not interrupted:
        ...
        if os.path.exists(daily_path3):
            ...
            if df_daily is not None and len(df_daily) > 0:
                ...
                #removed SOURCEURL
                essential_columns = ['GLOBALEVENTID','DATEADDED','Actor1Geo_CountryCode', 'Actor2Geo_CountryCode',
...
def main():
    ...
    FOCAL_COUNTRIES = ['CA']  # Countries we're analyzing
#############################################################################################COUNTRY
    ...
    #enhanced list
    default_counterparts = ['RS','IZ','IS','IR', 'AG', 'AJ', 'AM','BG', 'CH', 'GZ', 'HK', 'IN', 'ID', 'KN', 'KZ', 'LY','MD','MY', 'NU','NI', 'PK', 'SA', 'SU', 'SY','TU', 'UZ', 'VE', 'WE', 'YM', 'XX','BU', 'TC', 'LE', 'VN','BO']
    #default_counterparts = ['RS', 'CH']
...
# Apply the function to your column
    ...
    mergedname4=f'singularADD3_cyber_events_{YEAR}_{focal_country}_{root}_{cps}_{random_str}.xlsx'
